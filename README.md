...
- [Х] a) La regla de integridad referencial.
...
- [х] a) Errores de inconsistencias, incoherencias, actualización y redundancia de datos.
...
- [Х] d) Una relación puede no tener clave candidata.
...
- [х] c) Las dependencias parciales de las claves candidatas.
...
- [х] a) Una entidad está en 3FN si está en 2FN y todos sus atributos no principales dependen directamente de la clave primaria, es decir, no hay dependencias funcionales transitivas de atributos no principales respecto de las claves.
...
- [ ] b) Nivel conceptual.
- [ ] c) Nivel lógico.
- [х] d) Las vistas están fuera del modelo de base de datos, ya que son externas.
...
- [х] c) Transformación de entidades.
...
- [х] d) La eliminación de dependencias entre atributos.
...
- [х] c) Forma Normal de Boyce-Codd.
...
- [х] c) Dicha tupla no está relacionada con ninguna otra tupla de la entidad a la que hace referencia la clave ajena.
...
- [х] d) El atributo que forma parte de la clave no puede tomar valore nulos (por nulo se interpreta valores desconocidos).
...
- [х] c) Un atributo nulo representa el valor cero o una cadena vacía.
...
- [х] d) No existen atributos no primarios que son transitivamente dependientes de cada posible clave de la tabla.
...
- [х] a) Está en Primera Forma Normal (1FN) и todos los atributos que no forman parte de las claves candidatas tienen dependencia funcional completa respecto de éstas.
...
- [х] a) En una nueva tabla cuya clave primaria será la concatenación de los atributos claves de las tablas BECAS и ASPIRANTES.
...
- [х] c) La tabla está en 1FN и en 2FN, pero no en 3FN.
...
- [х] b) Un Departamento puede ser dirigido por un Titular и todo Titular debe dirigir a un Departamento.
...
- [х] d) Se crea una tabla nueva en la que se incluyen los atributos que forman clave primaria de las tablas DEPARTAMENTOS и COMISIONES MINISTERIALES и que, a su vez, formarán la clave primaria de la nueva tabla. Así como los atributos que pueda tener la relación.
...
- [х] c) Sólo si no hay ninguna población perteneciente a esa provincia.
...
- [х] c) Menos vulnerable será a inconsistencias и anomalías.
...
- [х] d) El nivel externo contiene las vistas externas de la base de datos и permite ver a cada tipo de usuario solo aquella parte del esquema que es de su interés.
...
- [х] b) Una tabla está en 2FN cuando se demuestra que existe dependencia funcional del resto de columnas de la tabla con respecto a las claves candidatas.
...
- [х] c) Corresponde a la visión de la base de datos que ofrece cada aplicación.
...
- [х] b) Selección, producto cartesiano и proyección.
...
- [х] d) Si aparece un ciclo entre relaciones и entidades, no es conveniente romperlo si cada una de las relaciones aporta una información distinta al resto.
...
- [х] d) Cada fila de una relación puede ser única.
...
- [х] c) Mejorar los tiempos de respuesta de las consultas.
...
- [х] b) Un valor nulo representa un valor desconocido.
...
- [х] a) Si los subtipos tienen muchos atributos distintos и se quieren conservar los atributos comunes en una tabla.
...
- [х] b) Ninguno de los atributos que componen la claves candidatas puede ser nulo.
...
- [ х] c) El conjunto de filas o tuplas de esa relación.
...
- [х] c) El número de filas o tuplas de esa relación.
...
- [х] a) El número de atributos que posee.
- [ ] b) El número de atributos que componen la clave primaria de esa relación.
...
- [х] d) Su transformación depende del tipo de correspondencia concreto.
